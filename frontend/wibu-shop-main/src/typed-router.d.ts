...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    '/AdminAccountPage': RouteRecordInfo<'/AdminAccountPage', '/AdminAccountPage', Record<never, never>, Record<never, never>>,
  ...
  export interface _RouteFileInfoMap {
    'src/pages/AdminAccountPage.vue': {
      routes: '/AdminAccountPage'
      views: never
    }
